          ...
          <div className={style.content} id="downloadsub2">
            ...
            <ul className={style.ul}>
              <li className={style.li}>
                <i
                  ...
                  style={{ marginRight: "10px", color: "#14bef0" }}
                ></i>
            ...
            <div className={style.applinkwrap}>
              ...
              <form className={style.form}>
                <div className={style.inpcontainer}>
                  <div className={style.code}>+91</div>
                  <input
                    type="tel"
            ...
            <div className={style.storylink}>
              <a href="/doctor" className={style.link}>
                <img
                  src="https://www.practo.com/consult/static/images/google-play-badge.png"
                  alt="p"
                  style={{
                    width: "130px",
                    height: "40px",
              ...
              <a href="/doctor" className={style.link}>
                <img
                  src="https://www.practo.com/consult/static/images/app-store-badge.png"
                  alt="a"
                  style={{
                    width: "130px",
                    height: "40px",
